...
# Files above this size are treated as package binaries/runtime (uv, model
# weights, dumps, swap-like blobs) — never user config/data — and reinstalled
# with the package. Keeps payload minimal and name-agnostic.
...
PRUNE_ABS_DIRS = [
    ...
    "usr/local/share/uv",
    "usr/local/x-ui/bin",
    # Hermes keeps managed runtimes/bundled content inside its data dir too
    # (bin/uv, skills/, legacy code clones) — all regenerated by the installer.
    "root/.hermes/bin",
    "root/.hermes/skills",
