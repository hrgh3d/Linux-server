...
restore_path "usr/local/lib/hermes-agent" "/usr/local/lib/hermes-agent"
restore_path "usr/local/share/uv" "/usr/local/share/uv"
restore_path "usr/local/x-ui"     "/usr/local/x-ui"
...
for d in /etc/ssh /usr/local/bin /usr/local/sbin /usr/local/lib/node_modules \
         /usr/local/lib/hermes-agent /usr/local/share/uv /usr/local/x-ui \
         /opt /srv /var/www /var/spool/cron; do
